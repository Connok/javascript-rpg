...
const locations = [
    ...
    },
    {
        ...
        text: `You find a secret game. Pick a number above. Ten numbers will be randomly chosen between 0 and 10. If the number you choese matches on of the random numbers, you win!`
    }
